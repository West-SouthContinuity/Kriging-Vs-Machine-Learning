...
def make_variogram3(
    ...
    :param nst: number of structures
    :param it1: type of the first variogram structure
    :param cc1: contribution of the first structure
    :param azi1: azimuth of the first structure
    :param hmaj1: major range of the first structure
    :param hmin1: minor range of the first structure
    :param it2: type of the second variogram structure
    :param cc2: contribution of the second structure
    :param azi2: azimuth of the second structure
    :param hmaj2: major range of the second structure
    :param hmin2: minor range of the second structure
    :param it3: type of the third variogram structure
    :param cc3: contribution of the third structure
    :param azi3: azimuth of the third structure
    :param hmaj3: major range of the third structure
    :param hmin3: minor range of the third structure
    :return: dictionary with variogram parameters
    """
    if cc2 == 0 and cc3 == 0:
        nst = 1
    elif cc3 == 0:
    ...
    # Check if the sill sums up to 1
    if nug + cc1 + cc2 + cc3 != 1:
        print("\x1b[0;30;41m make_variogram3 Warning: sill does not sum to 1.0, do not use in simulation \x1b[0m")

    # Check for positive contributions and ranges
    if any(x < 0 for x in [cc1, cc2, cc3, nug, hmaj1, hmaj2, hmaj3, hmin1, hmin2, hmin3]):
        print("\x1b[0;30;41m make_variogram3 Warning: contributions and ranges must be all positive \x1b[0m")

    # Check if major range is greater than minor range for each structure
    for hmaj, hmin in [(hmaj1, hmin1), (hmaj2, hmin2), (hmaj3, hmin3)]:
        if hmaj < hmin:
            print("\x1b[0;30;41m make_variogram3 Warning: major range should be greater than minor range \x1b[0m")
